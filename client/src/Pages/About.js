  ...
  return (
    <div className="page">
      ...
      <ul>
        ...
        <li>Level: 221 (as of July 15, 2021)</li>
        <li>I have been playing Maplestory starting around mid May 2021</li>
        <li>
          My first character was Dual Blade which I played till 200 and neo tera
          event came along
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          ...
          beginner side of coding. I took a class from UC Berkeley Extension on
          full stack web development and continued learning more after that.
        </li>
        <li>
          Job: currently looking for a job as of July 2021. I've had a few
          offers but not entirely in the direction I would like to go. If anyone
          has a legitimate job offer, feel free to contact me via LinkedIn:
          https://www.linkedin.com/in/max-higa-2460351b4/
        </li>
        <li>
